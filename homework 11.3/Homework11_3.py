...
with open("score_list.json", "r") as score_file:
    ...
    new_score_list = sorted(score_list, key=lambda K: K["attempts"])[:3] #Esta função vai ordenar por ordem crescente a score_list com base na variavel attempts, o "[:3]" serve para indicar que só apresenta os 3 primeiros resultados
